...
class NfcData {
  ...
  factory NfcData.fromMap(Map data) {
    NfcData result = NfcData(
      nfcId: data['nfcId'],
      nfcContent: data['nfcContent'],
      nfcError: data['nfcError'],
